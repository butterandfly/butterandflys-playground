---
title: Sample Space 🚀
desc: "Probability 01-02: Describe outcomes with Sample Space."
...
So the sample space $\{1,2,3,4,5\}$ is not collectively exhaustive for the Rolling a Dice: 
you might roll a 6, but it's not in the sample space.
GotIt]]
...
[[GotIt
## Exercises
Now let have some exercise about the Sample Space.
GotIt]]
